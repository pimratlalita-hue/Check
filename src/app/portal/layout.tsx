...
export default async function PortalLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 selection:bg-rose-100 selection:text-rose-900">
      {/* Modern Dynamic Navigation Bar */}
      <PortalNavbar
        logoUrl={tenantInfo.logoUrl}
        orgNameTh={tenantInfo.nameTh}
        orgNameEn={tenantInfo.nameEn}
        utilities={
          <>
            <NotificationBell />
            <RoleSwitcher />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                {locale === "en"
                  ? "Excellence in language education, humanities research, intelligent systems, and graduate thesis innovations."
                  : "มุ่งมั่นสู่ความเป็นเลิศด้านภาษาศาสตร์ มนุษยศาสตร์ นวัตกรรมปัญญาประดิษฐ์และวิทยานิพนธ์ระดับบัณฑิตศึกษา"}
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              {hasAnyContact ? (
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  {locale === "en"
                    ? "Department of Foreign Languages, Faculty of Humanities, MCU Campus\nTel: 035-248-000 | Email: grad.humanities@mcu.ac.th"
                    : "ภาควิชาภาษาต่างประเทศ คณะมนุษยศาสตร์ มหาวิทยาลัยมหาจุฬาลงกรณราชวิทยาลัย\nโทรศัพท์: 035-248-000 | อีเมล: grad.humanities@mcu.ac.th"}
                </p>
              )}
            </div>
          </div>
